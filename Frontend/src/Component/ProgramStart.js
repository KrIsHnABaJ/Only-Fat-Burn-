              ...
              <div className="row g-5 gb-5">
                  <div className="col-lg-4 col-md-6">
                      <div className="bg-light rounded text-center p-5">
                          ...
                          <p> Build muscle, strength, and definition through weight training and proper nutrition.</p>
                  ...
                  <div className="col-lg-4 col-md-6">
                      <div className="bg-light rounded text-center p-5">
                          ...
                          <p> Use resistance to build strength and muscle through controlled movements with weights.</p>
                          <a className="text-uppercase" href>Read More <i className="bi bi-arrow-right" /></a>
                      </div>
                  </div>
                  <div className="col-lg-4 col-md-6">
                      <div className="bg-light rounded text-center p-5">
                          ...
                          <p> Strengthen and grow muscles through targeted resistance training and nutrition.</p>
                          <a className="text-uppercase" href>Read More <i className="bi bi-arrow-right" /></a>
                      </div>
                  </div>
                  <div className="col-lg-12 col-md-6 text-center">
                      <h1 className="text-uppercase text-light mb-4">30% Discount For This Festival Season</h1>
